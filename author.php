            ...
            <div class="col-md-8">
                ...
                ?>
                  ...
                  <?php
                    ...
                    ?>
                    <?php
                    $sql1 = "SELECT * FROM post WHERE author=$cid";
                    ...
                    if(mysqli_num_rows($result1) > 0)
                    {
                        ...
                        if($page > 1)
                        {
                            echo "<li><a href='author.php?aid=".$cid."&page=".($page-1)."'>Previous</a></li>";
                        }
                        for($i = 1 ; $i <= $total_page ; $i++)
                        {
                            ...
                            echo "<li class=".$active."><a href='author.php?aid=".$cid."&page=".$i."'>".$i."</a></li>";
                        }
                        if($page < $total_page)
                        {
                            echo "<li><a href='author.php?aid=".$cid."&page=".($page+1)."'>Next</a></li>";
                        }
                    echo "</ul>";
                    }
                ?>
